...
import s from "./lineFoure.module.css";
...
class LineComponentFoure extends React.Component {
	...
	componentDidMount() {
		...
		this.TL
			...
			.to(this.lineItem, 2.2, {attr:{"stroke-dashoffset":0,ease: Power4.easeInOut}}, '+=4.9');
			// .fromTo(this.lineItem, 2.2, {x: -280}, {x: 0,ease: Power4.easeInOut}, '+=5.1');
...
export default LineComponentFoure;
