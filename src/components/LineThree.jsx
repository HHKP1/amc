...
import s from "./lineThree.module.css";
...
class LineComponentThree extends React.Component {
	...
	componentDidMount() {
		...
		this.TL
			...
			.to(this.lineItem, 2.2, {attr:{"stroke-dashoffset":0,ease: Power4.easeInOut}}, '+=4.3');
		// this.TL.fromTo(this.lineItem, 2.2, {x: -280}, {x: 0,ease: Power4.easeInOut}, '+=5.5');
...
export default LineComponentThree;
